...
**Status: 6/6 Codex-xhigh APPROVED (F1a–F1f) — FEATURE COMPLETE. Pending: final full-suite gate + live-verify on an alt port + merge decision.** Opt-in `turn_capture_dir` writes ONE atomic JSON per turn
