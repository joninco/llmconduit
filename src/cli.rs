...
pub fn run_configure_flow(path: PathBuf) -> Result<PersistedConfig, String> {
    ...
    let config = PersistedConfig {
        ...
        upstream_retry: existing.upstream_retry.clone(),
        upstream_circuit_breaker: existing.upstream_circuit_breaker.clone(),
        upstream_bulkhead: existing.upstream_bulkhead.clone(),
